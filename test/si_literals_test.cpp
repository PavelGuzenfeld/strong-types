...
static_assert(std::is_same_v<decltype(1.0_K)::tag_type, TemperatureTag>);
static_assert(std::is_same_v<decltype(1.0_degC), Celsius<double>>, "a Celsius literal is a point, not an interval");
